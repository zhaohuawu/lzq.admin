<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="filtersQuery.userName" placeholder="操作人" style="width: 200px;" clearable class="filter-item" />
      <el-select v-model="filtersQuery.httpMethod" placeholder="请求方式" clearable class="filter-item">
        <el-option v-for="(item,index) in httpMethods" :key="index" :label="item" :value="item" />
      </el-select>
...
export default {
  ...
  data() {
    return {
      ...
      tableCols: [
        ...
        { label: '请求方式', prop: 'httpMethod', type: 'Tag', align: 'center', width: '80' },
        ...
        { label: '操作设备', prop: 'browserInfo', type: 'Dialog', btnName: 'Info', align: 'center' },
        { label: '耗时(ms)', prop: 'executionDuration', align: 'center', width: '80' },
        { label: '操作时间', prop: 'executionTime', type: 'DateTime', align: 'center', width: '150', sortable: 'custom' },
  ...
  methods: {
    ...
    handleFilter() {
      ...
      if (this.filtersQuery.httpMethod !== '' && this.filtersQuery.httpMethod !== null) {
        filterArray.push('["httpMethod","contains","' + this.filtersQuery.httpMethod + '"]')
      }
